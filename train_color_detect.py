...
model = train_model(epochs=10000,backgrounds=backgrounds,seed=30,train_device=pytorch_device,num_samples=50000,num_workers=5) # trains then returns the trained model
