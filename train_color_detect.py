...
model = train_model(epochs=10000, backgrounds=backgrounds, seed=30, train_device=pytorch_device, num_samples=30000,
                    num_workers=10, weights_path="models/color_detection.pt")  # trains then returns the trained model
